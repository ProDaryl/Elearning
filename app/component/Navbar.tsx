...
const Navbar = () => {
    ...
    return (
        ...
        <div className="px-2 w-full lg:px-5 pt-5 bg-background fixed z-10">
            <nav className="relative flex justify-between items-center p-2 px-6 w-full shadow-sm shadow-gray-200">
                <div className="flex gap-[10px] lg:gap-[40px] items-center justify-center">
                    <div className=" p-2 md:py-2 md:px-1 lg:p-2 rounded text-white bg-orange-400"><Logo /></div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Link href={"/signup"} className="py-[12px] px-[10px] lg:px-[24px] rounded-md hover:text-white hover:bg-orange-400 duration-500">Sign Up</Link>
                    <Link href={"/login"} className="py-[12px] px-[20px] md:px-[24px] text-white bg-orange-400 hover:bg-orange-500/90 rounded-md duration-300 hover:scale-105">Login</Link>
